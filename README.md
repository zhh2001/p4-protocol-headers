...
- **105 protocols** covering L2 to L7
...
- Pseudocode examples (commented out) for reference
...
| --- | --- | --- | --- |
| `ail.p4` | AI-Lossless | Artificial Intelligence Driven Lossless Network Protocol | AI 无损网络协议 |
...
| `bsnp.p4` | BSNP | Biosensor Network Protocol | 生物传感器网络协议 |
...
| `dosp.p4` | DOSP | Digital Olfaction Streaming Protocol | 数字嗅觉流传输协议 |
| `dpdk.p4` | DPDK | Data Plane Development Kit Acceleration Protocol | DPDK 数据平面加速协议 |
...
| `gnmi.p4` | gNMI | gRPC Network Management Interface | gRPC 网络管理接口协议 |
| `gnoi.p4` | gNOI | gRPC Network Operations Interface | gRPC 网络设备操作接口协议 |
| `gptp.p4` | gPTP | Generalized Precision Time Protocol | 广义精确时间协议 |
| `gre.p4` | GRE | Generic Routing Encapsulation | 通用路由封装协议 |
| `gsdp.p4` | GSDP | Genomic Sequencing Data Protocol | 基因组测序数据协议 |
| `gtp_u.p4` | GTP-U | GPRS Tunneling Protocol User Plane | GPRS 隧道协议用户面 |
| `holotp.p4` | HoloTP | Holographic Transport Protocol | 全息传输协议 |
| `hpcx.p4` | HPC-X | High Performance Computing Communication Protocol | 高性能计算通信协议 |
| `http.p4` | HTTP/1.1 | Hypertext Transfer Protocol version 1.1 | 超文本传输协议 |
| `http2.p4` | HTTP/2 | Hypertext Transfer Protocol version 2 | 超文本传输协议第 2 版 |
| `http3.p4` | HTTP/3 | Hypertext Transfer Protocol version 3 | 超文本传输协议第 3 版 |
...
| `islcp.p4` | ISLCP | Inter-Satellite Laser Communication Protocol | 星间激光通信协议 |
...
| `nnp.p4` | NNP | Neuromorphic Network Protocol | 类脑网络协议 |
...
| `oc.p4` | OpenConfig | OpenConfig Data Models | OpenConfig 数据模型 |
| `ofp.p4` | OpenFlow | OpenFlow Protocol | OpenFlow 协议 |
| `ospf.p4` | OSPF | Open Shortest Path First | 开放式最短路径优先路由协议 |
| `p4runtime.p4` | P4Runtime | P4Runtime Protocol | P4Runtime 协议 |
...
| `restconf.p4` | RESTCONF | RESTCONF Protocol | RESTCONF 协议 |
...
| `smb.p4` | SMB | Server Message Block | 服务器消息块协议 |
| `smtp.p4` | SMTP | Simple Mail Transfer Protocol | 简单邮件传输协议 |
| `snmp.p4` | SNMP | Simple Network Management Protocol | 简单网络管理协议 |
| `snmpv3.p4` | SNMPv3 | Simple Network Management Protocol v3 | 简单网络管理协议第 3 版 |
...
| `telnet.p4` | Telnet | Telnet Protocol | 远程终端协议 |
...
| `websocket.p4` | WebSocket | WebSocket Protocol | WebSocket 协议 |
| `yang.p4` | YANG | Yet Another Next Generation | YANG 数据建模语言 |
